...
const CreateAnn = () => {
    ...
    const handleAdd = async (e) => {
        e.preventDefault();
        try {
            const newAnnRef = doc(collection(db, "Announcements"));
            await setDoc(newAnnRef, ann);

         

            swal("Good job!", "An announcement has been published", "success").then((value) => {
                navigate(-1);
            });
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="login-reg-bg">
                        <div class="log-reg-area sign">
                            <h2 class="log-title text-center">Publish an Announcement</h2>
                            ...
                            <form onSubmit={handleAdd} >
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="control-label" for="input">Announcement Number</label>
                                    <i class="mtrl-select"></i>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" id="details"    onChange={handleInput} />
                                    <label class="control-label" for="input">Additional Link</label>
                                    <i class="mtrl-select"></i>
                                </div>
