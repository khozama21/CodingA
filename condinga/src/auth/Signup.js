                                ...
                                <div class="login-reg-bg">
                                    <div class="log-reg-area sign">
                                        ...
                                        <form onSubmit={this.handleSubmit}>
                                            ...
                                            <div class="form-group">
                                                <input type="text" id="email" required="required" onChange={this.handleChange} />
                                            ...
                                            <div class="form-group">
                                                <input type="text" id="education" required="required" onChange={this.handleChange} />
                                                <label class="control-label" for="input">Education</label>
                                                <i class="mtrl-select"></i>
                                            </div>
                                            <div class="form-group">
                                                <input type="date" id="dob" required="required" onChange={this.handleChange} />
                                                <label class="control-label" for="Date Of Birth">Name</label>
                                                <i class="mtrl-select"></i>
                                            </div>

                                            <div class="form-group">
                                                <input type="text" id="git" required="required" onChange={this.handleChange} />
                                                <label class="control-label" for="GitHub">Name</label>
                                                <i class="mtrl-select"></i>
                                            </div>
                                            {/* <div class="checkbox">
                                                <label>
